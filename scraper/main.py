        ...
        try:
            ...
            while page <= max_pages:
                ...
                for index, listing in enumerate(raw_listings):
                    ...
                    listing_url = listing.get('link_token', '')
                    if listing_url:
                        listing_url = f"https://www.yad2.co.il/item/{listing_url}"
                        try:
                ...
                # For bonus mode, limit to 5 listings
                if filter_type == 'test' and len(all_listings) >= 5:
                    all_listings = all_listings[:5]
                    logger.info(f"Bonus mode: limited to 5 listings")
                    break
